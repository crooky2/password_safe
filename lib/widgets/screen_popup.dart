...
class ScreenPopup extends StatelessWidget {
	...
	Widget build(BuildContext context) {
		...
		final popupWidth = mediaQuery.width > maxWidth ? maxWidth : mediaQuery.width;
		final popupHeight = mediaQuery.height * maxHeightFactor;
		final hasHeaderText = (title?.trim().isNotEmpty ?? false) ||
